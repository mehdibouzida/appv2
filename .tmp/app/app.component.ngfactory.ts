...
class _View_MyApp_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._MyApp_0_4 = new Wrapper_MyApp(this.parentInjector.get(import8.Platform),this.parentInjector.get(import9.LoadingController));
...
class _View_MyApp0 extends import1.AppView<import0.MyApp> {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import24.Nav) && (0 === requestNodeIndex))) { return this._Nav_0_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
