...
import * as import44 from '../providers/auth-data';
import * as import45 from '../providers/event-data';
import * as import46 from '../providers/profile-data';
import * as import47 from '../providers/dish-data';
import * as import48 from '../providers/order-data';
import * as import49 from '../providers/geolocation-data';
...
import * as import61 from '../pages/event-create/event-create.ngfactory';
import * as import62 from '../pages/event-detail/event-detail.ngfactory';
import * as import63 from '../pages/event-list/event-list.ngfactory';
import * as import64 from '../pages/login/login.ngfactory';
import * as import65 from '../pages/profile/profile.ngfactory';
import * as import66 from '../pages/reset-password/reset-password.ngfactory';
import * as import67 from '../pages/signup/signup.ngfactory';
import * as import68 from '../pages/dish-list/dish-list.ngfactory';
import * as import69 from '../pages/dish-create/dish-create.ngfactory';
import * as import70 from '../pages/dish-detail/dish-detail.ngfactory';
import * as import71 from '../pages/dish-order-pay/dish-order-pay.ngfactory';
import * as import72 from '../pages/master-page/master-page.ngfactory';
import * as import73 from '../pages/order-list/order-list.ngfactory';
import * as import74 from '../pages/order-active-list/order-active-list.ngfactory';
import * as import75 from '../pages/order-history-list/order-history-list.ngfactory';
import * as import76 from '@angular/core/src/application_tokens';
import * as import77 from '@angular/platform-browser/src/dom/events/dom_events';
import * as import78 from '@angular/platform-browser/src/dom/events/key_events';
...
import * as import81 from '@angular/platform-browser/src/dom/debug/ng_probe';
import * as import82 from './app.component';
import * as import83 from '@angular/common/src/location/platform_location';
import * as import84 from '@angular/common/src/location/location_strategy';
...
import * as import87 from 'ionic-angular/platform/query-params';
...
import * as import92 from 'ionic-angular/transitions/transition-registry';
...
import * as import104 from 'ionic-angular/components/app/app-root';
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __DeepLinker_73:any;
  __AuthData_74:import44.AuthData;
  __EventData_75:import45.EventData;
  __ProfileData_76:import46.ProfileData;
  __DishData_77:import47.DishData;
  __OrderData_78:import48.OrderData;
  __GeolocationData_79:import49.GeolocationData;
  constructor(parent:import50.Injector) {
    super(parent,[
      ...
      import61.EventCreatePageNgFactory,
      import62.EventDetailPageNgFactory,
      import63.EventListPageNgFactory,
      import64.LoginPageNgFactory,
      import65.ProfilePageNgFactory,
      import66.ResetPasswordPageNgFactory,
      import67.SignupPageNgFactory,
      import68.DishListPageNgFactory,
      import69.DishCreatePageNgFactory,
      import70.DishDetailPageNgFactory,
      import71.DishOrderPayPageNgFactory,
      import72.MasterPageNgFactory,
      import73.OrderListPageNgFactory,
      import74.OrderActiveListPageNgFactory,
      import75.OrderHistoryListPageNgFactory,
      import53.IonicAppNgFactory
    ]
    ,[import53.IonicAppNgFactory]);
  }
  ...
  get _APP_ID_29():any {
    if ((this.__APP_ID_29 == (null as any))) { (this.__APP_ID_29 = import76._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_32():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_32 == (null as any))) { (this.__EVENT_MANAGER_PLUGINS_32 = [
      new import77.DomEventsPlugin(),
      new import78.KeyEventsPlugin(),
      new import79.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_31)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_32;
  }
  get _EventManager_33():import16.EventManager {
    if ((this.__EventManager_33 == (null as any))) { (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32,this.parent.get(import80.NgZone))); }
  ...
  get _RootRenderer_37():any {
    if ((this.__RootRenderer_37 == (null as any))) { (this.__RootRenderer_37 = import81._createConditionalRootRenderer(this._DomRootRenderer_36,this.parent.get(import81.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_53():any {
    if ((this.__AppRootToken_53 == (null as any))) { (this.__AppRootToken_53 = import82.MyApp); }
  ...
  get _Keyboard_61():import34.Keyboard {
    if ((this.__Keyboard_61 == (null as any))) { (this.__Keyboard_61 = new import34.Keyboard(this._Config_21,this._Form_58,this.parent.get(import80.NgZone))); }
  ...
  get _LocationStrategy_63():any {
    if ((this.__LocationStrategy_63 == (null as any))) { (this.__LocationStrategy_63 = import8.provideLocationStrategy(this.parent.get(import83.PlatformLocation),this.parent.get(import84.APP_BASE_HREF,(null as any)),this._Config_21)); }
  ...
  get _TapClick_69():import41.TapClick {
    if ((this.__TapClick_69 == (null as any))) { (this.__TapClick_69 = new import41.TapClick(this._Config_21,this._App_22,this.parent.get(import80.NgZone))); }
  ...
  get _UrlSerializer_72():any {
    if ((this.__UrlSerializer_72 == (null as any))) { (this.__UrlSerializer_72 = import85.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_72;
  }
  get _DeepLinker_73():any {
    if ((this.__DeepLinker_73 == (null as any))) { (this.__DeepLinker_73 = import86.setupDeepLinker(this._App_22,this._UrlSerializer_72,this._Location_64)); }
    return this.__DeepLinker_73;
  }
  get _AuthData_74():import44.AuthData {
    if ((this.__AuthData_74 == (null as any))) { (this.__AuthData_74 = new import44.AuthData()); }
    return this.__AuthData_74;
  }
  get _EventData_75():import45.EventData {
    if ((this.__EventData_75 == (null as any))) { (this.__EventData_75 = new import45.EventData()); }
    return this.__EventData_75;
  }
  get _ProfileData_76():import46.ProfileData {
    if ((this.__ProfileData_76 == (null as any))) { (this.__ProfileData_76 = new import46.ProfileData()); }
    return this.__ProfileData_76;
  }
  get _DishData_77():import47.DishData {
    if ((this.__DishData_77 == (null as any))) { (this.__DishData_77 = new import47.DishData()); }
    return this.__DishData_77;
  }
  get _OrderData_78():import48.OrderData {
    if ((this.__OrderData_78 == (null as any))) { (this.__OrderData_78 = new import48.OrderData()); }
    return this.__OrderData_78;
  }
  get _GeolocationData_79():import49.GeolocationData {
    if ((this.__GeolocationData_79 == (null as any))) { (this.__GeolocationData_79 = new import49.GeolocationData()); }
    return this.__GeolocationData_79;
  }
  createInternal():import1.AppModule {
    ...
    this._QueryParams_14 = import87.setupQueryParams(this._UrlToken_13);
    this._PlatformConfigToken_15 = import88.providePlatformConfigs();
    ...
    this._Platform_20 = import89.setupPlatform(this._PlatformConfigToken_15,this._QueryParams_14,this._UserAgentToken_16,this._NavigatorPlatformToken_17,this._DocumentDirToken_18,this._DocLangToken_19,this.parent.get(import80.NgZone));
    this._Config_21 = import90.setupConfig(this._ConfigToken_12,this._QueryParams_14,this._Platform_20);
    this._App_22 = new import10.App(this._Config_21,this._Platform_20);
    this._APP_INITIALIZER_23 = [
      import91.registerModeConfigs(this._Config_21),
      import92.registerTransitions(this._Config_21),
      import30.setupProvideEvents(this._Platform_20),
      import41.setupTapClick(this._Config_21,this._App_22,this.parent.get(import80.NgZone))
    ]
    ;
    this._ApplicationInitStatus_24 = new import11.ApplicationInitStatus(this._APP_INITIALIZER_23);
    this._Testability_25 = new import12.Testability(this.parent.get(import80.NgZone));
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import80.NgZone),this.parent.get(import93.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import94.LOCALE_ID)) { return this._LOCALE_ID_9; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_10; }
    if ((token === import95.ErrorHandler)) { return this._ErrorHandler_11; }
    if ((token === import90.ConfigToken)) { return this._ConfigToken_12; }
    if ((token === import87.UrlToken)) { return this._UrlToken_13; }
    if ((token === import87.QueryParams)) { return this._QueryParams_14; }
    if ((token === import88.PlatformConfigToken)) { return this._PlatformConfigToken_15; }
    if ((token === import89.UserAgentToken)) { return this._UserAgentToken_16; }
    if ((token === import89.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_17; }
    if ((token === import89.DocumentDirToken)) { return this._DocumentDirToken_18; }
    if ((token === import89.DocLangToken)) { return this._DocLangToken_19; }
    if ((token === import89.Platform)) { return this._Platform_20; }
    if ((token === import90.Config)) { return this._Config_21; }
    ...
    if ((token === import76.APP_ID)) { return this._APP_ID_29; }
    if ((token === import96.DOCUMENT)) { return this._DOCUMENT_30; }
    if ((token === import79.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_31; }
    ...
    if ((token === import97.AnimationDriver)) { return this._AnimationDriver_35; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_36; }
    if ((token === import98.RootRenderer)) { return this._RootRenderer_37; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_38; }
    if ((token === import99.Sanitizer)) { return this._Sanitizer_39; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_40; }
    if ((token === import100.IterableDiffers)) { return this._IterableDiffers_41; }
    if ((token === import101.KeyValueDiffers)) { return this._KeyValueDiffers_42; }
    ...
    if ((token === import104.AppRootToken)) { return this._AppRootToken_53; }
    if ((token === import85.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_54; }
    ...
    if ((token === import84.LocationStrategy)) { return this._LocationStrategy_63; }
    ...
    if ((token === import85.UrlSerializer)) { return this._UrlSerializer_72; }
    if ((token === import86.DeepLinker)) { return this._DeepLinker_73; }
    if ((token === import44.AuthData)) { return this._AuthData_74; }
    if ((token === import45.EventData)) { return this._EventData_75; }
    if ((token === import46.ProfileData)) { return this._ProfileData_76; }
    if ((token === import47.DishData)) { return this._DishData_77; }
    if ((token === import48.OrderData)) { return this._OrderData_78; }
    if ((token === import49.GeolocationData)) { return this._GeolocationData_79; }
